<template>
    <div class="app-container calendar-list-container">
        ...
        <div class="filter-container">
            ...
            <el-input @keyup.enter.native="handleFilter" style="width: 120px;" class="filter-item" placeholder="商户" v-model="listQuery.payName"></el-input>
...
<script>
import { fetchList, fetchCapital } from '@/admin/api/businessBalance'
...
export default {
    ...
    methods: {
        ...
        handleDownload () {
            ...
            const tHeader = ['用户名', '商户名', '动作', '余额(RMB)', '金额(RMB)', '手续费(RMB)', '通道', '订单号', '订单时间', '完成时间']
            const filterVal = ['user_name', 'user_no', 'action', 'peybalance', 'payamount', 'peyfee', 'payname', 'payno', 'create_time', 'complete_time']
            const data = this.formatJson(filterVal, this.list)
            exportJsonToExcel(tHeader, data, '商户余额')
