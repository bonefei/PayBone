<template>
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            ...
            <el-button class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">添加角色</el-button>
        ...
        <el-dialog title="用户列表" :visible.sync="dialogUserFormVisible" @close="handleRefreshList">
            ...
            <el-table :key='tableKey' :data="listUser" v-loading="listUserLoading" element-loading-text="给我一点时间" border fit highlight-current-row
                ...
                <el-table-column align="center" label="类型">
                    <template slot-scope="scope">
                        <span v-if="scope.row.roles == 2">子管理员</span>
                        <span v-if="scope.row.roles == 3">普通用户</span>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="添加子管理员" :visible.sync="dialogAddFormVisible">
