<template>
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            <el-input @keyup.enter.native="handleFilter" style="width: 120px;" class="filter-item" placeholder="用户名" v-model="listQuery.payUser"></el-input>

            <el-input @keyup.enter.native="handleFilter" style="width: 120px;" class="filter-item" placeholder="商户" v-model="listQuery.payCode"></el-input>
        ...
        style="width: 100%">
            ...
            <el-table-column align="center" label="白名单(IP)">
                <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="180px" style='width: 500px; margin-left:50px;'>
                <el-form-item label="用户名" prop="payUser" v-show="dialogStatus=='create'">
                ...
                <el-form-item label="商户号" prop="payCode" v-show="dialogStatus=='create'">
...
<script>
import { fetchList, selectPayCodeOption, createGatewayWhitelist, updateGatewayWhitelist, deleteGatewayWhitelist, selectPayUserOption } from '@/admin/api/gatewayWhitelist'
...
export default {
    ...
    methods: {
        ...
        createData () {
            this.$refs['dataForm'].validate((valid) => {
                if (valid) {
                    ...
                    createGatewayWhitelist(this.temp).then((response) => {
        ...
        updateData () {
            ...
            updateGatewayWhitelist(tempData).then((response) => {
        ...
        handleDelete (ID) {
            this.$confirm('是否确定删除？', '提示', {
                ...
                deleteGatewayWhitelist(data).then((response) => {
