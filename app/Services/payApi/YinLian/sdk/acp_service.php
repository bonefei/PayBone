...
class AcpService {
	...
	static function sign(&$params, $cert_path, $cert_pwd) {
		if($params['signMethod']=='01')	{
			return AcpService::signByCertInfo($params, $cert_path, $cert_pwd);
		} else {
	 ...
	 * @return 是否成功
	 */
	static function validate($params,$rootCertPath, $middleCertPath) {
		...
		if($params['signMethod']=='01')
		{
			...
			if($params['version']=='5.0.0'){
				...
				$strCert = CertUtil::verifyAndGetVerifyCert($strCert,$rootCertPath, $middleCertPath);
				if($strCert == null){
