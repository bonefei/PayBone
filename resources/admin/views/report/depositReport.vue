<template>
    <div class="app-container calendar-list-container">
        <el-row class="panel-group" :gutter="40">
            <el-col :xs="12" :sm="12" :lg="12" class="card-panel-col" v-loading="capitalLoading">
                <div class="card-panel">
                    ...
                    <div class="card-panel-description">
                        <div class="card-panel-text">已支付金额</div>
            ...
            <el-col :xs="12" :sm="12" :lg="12" class="card-panel-col" v-loading="capitalLoading">
                <div class="card-panel">
                    ...
                    <div class="card-panel-description">
                        <div class="card-panel-text">未支付金额</div>
        ...
        <div class="filter-container">
            ...
            <el-input @keyup.enter.native="handleFilter" style="width: 120px;" class="filter-item" placeholder="商户号" v-model="listQuery.name"></el-input>

            <el-input @keyup.enter.native="handleFilter" style="width: 120px;" class="filter-item" placeholder="通道编号" v-model="listQuery.business"></el-input>
        ...
        style="width: 100%">
            <el-table-column align="center" label="状态">
                <template slot-scope="scope">
                    ...
                    <span v-else>
                        <span v-if="scope.row.status == '2'" style="color: green;">支付成功</span>
                        <span v-else-if="scope.row.status == '1'" style="color: red;">支付失败</span>
            ...
            <el-table-column align="center" label="金额(RMB)">
                <template slot-scope="scope">
                    <span :class="{amount_color_red: scope.row.payer_pay_amount > 0, amount_color_green: scope.row.payer_pay_amount < 0}">{{scope.row.payer_pay_amount}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="入金汇率">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="完成时间" width="140">
                <template slot-scope="scope">
            ...
            <el-table-column align="center" label="操作" width="200">
                <template slot-scope="scope">
                    ...
                    <el-button v-if="!scope.row.edit && scope.row.status === 2" type="danger" @click="handleRepeat(scope.row)" icon="el-icon-share">重发</el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
import { fetchList, updateDepositReportStatus, fetchCapital, repeatMessage } from '@/admin/api/depositReport'
...
export default {
    ...
    methods: {
        ...
        handleDownload () {
            ...
            const tHeader = ['状态', '用户名', '商户号', '金额(RMB)', '通道', '订单号', '手续费(RMB)', '入金汇率', '订单时间', '完成时间']
            const filterVal = ['status', 'user_name', 'pay_way_code', 'payer_pay_amount', 'pay_way_name', 'merchant_order_no', 'payer_fee', 'fee_rate', 'create_time', 'complete_time']
        ...
        handleRepeat (row) {
            this.$confirm('此操作会再次发送报文，请注意查收！', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                repeatMessage(row).then((response) => {
