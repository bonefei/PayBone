<?php
namespace App\Services\payApi\YinLian\sdk;
use App\Services\payApi\YinLian\sdk\LogUtil;
use App\Services\payApi\YinLian\sdk\CertUtil;
...
class SDKConfig {
	...
	function __construct(){
		...
		$configFilePath = storage_path(). "/wl_file/certs/acp_sdk.ini";
		...
		$this->signCertPath = storage_path().'/wl_file/certs/test/acp_test_sign.pfx';
		...
		$this->encryptCertPath = storage_path().'/wl_file/certs/test/acp_test_enc.cer';
		$this->rootCertPath = storage_path().'/wl_file/certs/test/acp_test_root.cer';
		$this->middleCertPath =  storage_path().'/wl_file/certs/test/acp_test_middle.cer';
		...
		$this->logFilePath =  storage_path().'/pay_logs/';
